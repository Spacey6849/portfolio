...
const projectsData = [
  ...
  },
  {
    ...
    gallery: [
      "/projects/PalliativeCare/AppointmentsAllScreen.jpeg",
      "/projects/PalliativeCare/AppointmentsHistoryScreen.jpeg",
      "/projects/PalliativeCare/AppointmentsPendingScreen.jpeg",
      "/projects/PalliativeCare/AppointmentsScreenAll2.jpeg",
      "/projects/PalliativeCare/AppointmentsUpcomingScreen.jpeg",
      "/projects/PalliativeCare/ChatScreen.jpeg",
      "/projects/PalliativeCare/ChatScreen2.jpeg",
      "/projects/PalliativeCare/CreateAccountScreen.jpeg",
      "/projects/PalliativeCare/CreateAccountsScreen2.jpeg",
      "/projects/PalliativeCare/Home.jpeg",
      "/projects/PalliativeCare/Home2.jpeg",
      "/projects/PalliativeCare/LandingPage.png",
      "/projects/PalliativeCare/Map.png",
      "/projects/PalliativeCare/MapsMarker.jpeg",
      "/projects/PalliativeCare/MapsScreen.jpeg",
      "/projects/PalliativeCare/MedicationReminderAlarm.jpeg",
      "/projects/PalliativeCare/MedicationsScreen.jpeg",
      "/projects/PalliativeCare/MedicationsScreen2.jpeg",
      "/projects/PalliativeCare/NotificationsScreen.jpeg",
      "/projects/PalliativeCare/PrivacyScreen.jpeg",
      "/projects/PalliativeCare/ProfileScreen.jpeg",
      "/projects/PalliativeCare/ProfileScreen2.jpeg",
      "/projects/PalliativeCare/VirtalTrendCheckin.jpeg",
      "/projects/PalliativeCare/VirtalTrendCheckin2.jpeg",
      "/projects/PalliativeCare/VirtalTrendCheckin3.jpeg",
      "/projects/PalliativeCare/VirtalTrendCheckin4.jpeg",
      "/projects/PalliativeCare/VirtalTrendCheckin5.jpeg",
      "/projects/PalliativeCare/VitalsAlertNotification.jpeg",
      "/projects/PalliativeCare/VitalTrendBreathingDifficulty.jpeg",
      "/projects/PalliativeCare/VitalTrendBreathingDifficulty2.jpeg",
      "/projects/PalliativeCare/VitalTrendBreathingDifficulty3.jpeg",
      "/projects/PalliativeCare/VitalTrendHeart.jpeg",
      "/projects/PalliativeCare/VitalTrendPain.jpeg",
      "/projects/PalliativeCare/VitalTrendPain2.jpeg",
      "/projects/PalliativeCare/VitalTrendPain3.jpeg",
      "/projects/PalliativeCare/VitalTrendReport.jpeg",
    ],
    duration: "2026",
    wip: true,
    highlights: [
  ...
  },
  {
    ...
    summary:
      "A collaborative architectural rendering workspace that turns model screenshots into concept explorations and photoreal outputs. Built for architects and designers with credit-gated generation, realtime collaboration, and project context memory.",
    details:
      "ArchBlizz AI is an architectural rendering platform for architects and interior designers. It combines prompt-driven concept and render workflows, a React Flow workspace for node-based refinement, Client Memory and Design System context, secure credit-gated billing, and realtime collaboration with render-status signaling.",
    github: "",
    live: "https://www.archblizz.tech",
    gradient: "from-sky-500/20 via-cyan-500/20 to-blue-500/20",
    icon: "🏗️",
    role: "",
    cardImage: "/projects/ArchBlizz/LandingPage.png",
    gallery: [
      "/projects/ArchBlizz/LandingPage.png",
      "/projects/ArchBlizz/WorkspacePage.png",
      "/projects/ArchBlizz/ProjectsPage.png",
      "/projects/ArchBlizz/FeaturesPage.png",
    ],
    duration: "2026",
    highlights: [
      "Turns model screenshots into concept and photoreal outputs",
      "Preserves project context through Client Memory and Design Systems",
      "Supports collaborative presence, cursor, and operation broadcasting",
      "Secures generation with auth, rate limits, CAPTCHA, and credit gates",
      "Refunds credits automatically if the pipeline fails",
    ],
    features: [
